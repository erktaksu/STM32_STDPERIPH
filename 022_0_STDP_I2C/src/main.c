...
{
	while(I2C_GetFlagStatus(I2C1,I2C_FLAG_BUSY)); //i2c uygun olana kadar bekle

	I2C_GenerateSTART(I2C1,ENABLE);

	while(!(I2C_CheckEvent(I2C1,I2C_EVENT_MASTER_MODE_SELECT)));

	I2C_Send7bitAddress(I2C1,address,I2C_Direction_Transmitter);//MESAJ GONDERICEM BÝLGÝSÝ
